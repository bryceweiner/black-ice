...
const ThemeCustomize = () => {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("primary_color") == null || localStorage.getItem("secondary_color") == null || localStorage.getItem("color") == null || localStorage.getItem("layout_version") == null) {
      ...
      dispatch(ADD_COLOR({ color: config_color, primary_color: config_primary,
        secondary_color: config_secondary, layout_version: config_layout_version }));
    }
        ...
        <div className="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">
          <NavLink className={activeTab1 === "1" ? "active" : ""} onClick={() => setActiveTab1("1")} id="c-pills-home-tab">
            <div className="settings" onClick={openCustomizer}>
              <img src={("../../../assets/images/customize.png")} alt="" />
            </div>
          </NavLink>
